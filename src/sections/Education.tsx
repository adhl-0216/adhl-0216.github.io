...
export default function EducationContainer() {
    ...
    return (
        <section id="education-container" className="min-h-[50dvh] flex flex-col my-12 lg:px-40 ">
            <h2 className="text-4xl mb-4 font-semibold">My Education</h2>
            <div className="flex flex-col lg:flex-row rounded-2xl bg-primary-500 p-6 gap-8">
                ...
                <div className="lg:w-3/4">
                    ...
                    <div className="text-md lg:text-xl font-bold text-text-200 mb-4">
                        Bachelor of Science (Honours) in Computing with Software Development
                    </div>
                    <button
                        onClick={() => setIsCollapsed(!isCollapsed)}
                        className="lg:hidden text-sm underline mb-2">
                        {isCollapsed ? 'Show more' : 'Show less'}
                    </button>
                    <div className={`text-justify ${isCollapsed ? 'hidden lg:block' : 'block'}`}>
